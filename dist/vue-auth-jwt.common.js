...
;// CONCATENATED MODULE: ./node_modules/.pnpm/@vue+cli-service@5.0.4_vue-template-compiler@2.6.14/node_modules/@vue/cli-service/lib/commands/build/setPublicPath.js
...
const authModule = config => {
  ...
  (axios_default()).defaults.baseURL = config.API_BASE_URL;
  return {
    namespaced: true,
    getters: {
...
;// CONCATENATED MODULE: ./node_modules/.pnpm/@vue+cli-service@5.0.4_vue-template-compiler@2.6.14/node_modules/@vue/cli-service/lib/commands/build/entry-lib.js
